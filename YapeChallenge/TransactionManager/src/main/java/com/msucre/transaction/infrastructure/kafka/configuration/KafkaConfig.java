...
public class KafkaConfig {
  ...
  @Bean
  public ReactiveKafkaProducerTemplate<String, TransactionEventDto> reactiveKafkaProducerTemplate(
  ...
  @Bean
  public ReactiveKafkaConsumerTemplate<String, TransactionEventResponseDto> reactiveKafkaConsumerTemplate(
      KafkaProperties properties) {
    ...
    ReceiverOptions<String, TransactionEventResponseDto> receiverOptions = ReceiverOptions.<String, TransactionEventResponseDto>create(
